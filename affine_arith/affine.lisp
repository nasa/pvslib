;; patch for fomals-sans-usings applied to nil
(defmethod formals-sans-usings ((n null)) nil )
...
(defstep aa-simple-numerical (expr &optional (precision 3) (maxdepth 5))
...
(defhelper affine-eq__ (names fnum &optional subs nohide)
  (let ((excl (append
	       *ia-excluded*
    ...
    (with-fresh-labels
     ...
     (expand "##")
     (flatten)
     (install-rewrites ("real_expr?"
		       "beval__"
		       "beval_vs"
		       "boolexpr_lfcs[ContextData_beval_vs,
                                      LAMBDA (bexpr:BoolExpr, ctxt0:ContextData_beval_vs):
...
(defstep aa-interval (&optional (fnums 1) (precision 3) maxdepth sat?
			     vars 
...
(defhelper abstract-and-then (fnums level steps)
