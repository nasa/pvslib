...
Run started at 1:28:30 7/8/2023.

_Note_: Time below is expressed in format DD:HH:MM:SS.SSS.
## Grand Totals 
|            | Formulas | Attempted | Succeeded | Missing | Total Time |
| ---:       | :---:    | :---:     | :---:     | :---:   | ---        |
| **totals** | **137**   | **137**    | **137**    | **0**  | **51.681 s**   |
|top|0|0|0|0|0.000|
|ieee754_double|0|0|0|0|0.000|
|ieee754_double_base|22|22|22|0|30.716|
|ieee754_format_parameters|7|7|7|0|0.432|
|ieee754_semantics|11|11|11|0|0.996|
|ieee754_data|0|0|0|0|0.000|
|ieee754_domain|37|37|37|0|8.842|
|ieee754_qlt|1|1|1|0|0.111|
|ieee754_qle|1|1|1|0|0.114|
|ieee754_qgt|1|1|1|0|0.111|
|ieee754_qge|1|1|1|0|0.118|
|ieee754_qeq|1|1|1|0|0.121|
|ieee754_qun|0|0|0|0|0.000|
|ieee754_add|3|3|3|0|0.744|
|ieee754_sub|4|4|4|0|1.285|
|ieee754_mul|3|3|3|0|1.637|
|ieee754_max|0|0|0|0|0.000|
|ieee754_min|0|0|0|0|0.000|
|ieee754_div|6|6|6|0|1.165|
|ieee754_abs|1|1|1|0|0.030|
|ieee754_sqt|2|2|2|0|0.060|
|ieee754_neg|2|2|2|0|0.073|
|ieee754_single|0|0|0|0|0.000|
|ieee754_single_base|22|22|22|0|3.468|
...
| ---     | ---          | ---                | ---  |
|er_ub_value|✅ proved - incomplete|shostak|15.970|
|er_lb_value|✅ proved - incomplete|shostak|14.130|
|add_double_finite_def|✅ proved - incomplete|shostak|0.020|
|sub_double_finite_def|✅ proved - incomplete|shostak|0.030|
|mul_double_finite_def|✅ proved - incomplete|shostak|0.053|
|div_double_finite_def_TCC1|✅ proved - incomplete|shostak|0.040|
|div_double_finite_def|✅ proved - incomplete|shostak|0.097|
|qeq_double_finite_def|✅ proved - incomplete|shostak|0.020|
|qge_double_finite_def|✅ proved - incomplete|shostak|0.039|
|qgt_double_finite_def|✅ proved - incomplete|shostak|0.020|
|qle_double_finite_def|✅ proved - incomplete|shostak|0.032|
|qlt_double_finite_def|✅ proved - incomplete|shostak|0.030|
|neg_double_finite_def|✅ proved - incomplete|shostak|0.011|
|finite?_double_add|✅ proved - complete|shostak|0.020|
|finite?_double_sub|✅ proved - incomplete|shostak|0.010|
|finite?_double_mul|✅ proved - incomplete|shostak|0.020|
|finite?_double_div|✅ proved - incomplete|shostak|0.017|
...
|double__finite?_projs_finite?_mul|✅ proved - incomplete|shostak|0.017|
...
|ieee754_precision_subtype_above_1|✅ proved - complete|shostak|0.026|
|ieee754_maxExp_TCC1|✅ proved - complete|shostak|0.080|
|ieee754_maxExp_subtype_above_1|✅ proved - complete|shostak|0.040|
|ieee754_minExp_TCC1|✅ proved - complete|shostak|0.236|

## `ieee754_semantics`

| Formula | Proof Status | Decision Procedure | Time |
| ---     | ---          | ---                | ---  |
|emin_TCC1|✅ proved - complete|shostak|0.724|
...
|is_finite_safe_projection_er_real|✅ proved - incomplete|shostak|0.052|
|safe_projection_er_real_proj_TCC1|✅ proved - incomplete|shostak|0.010|
|safe_projection_er_real_proj|✅ proved - incomplete|shostak|0.060|
...
|significand_lt_first_discrepancy|✅ proved - complete|shostak|0.153|
|smax_TCC1|✅ proved - complete|shostak|0.020|
|smin_TCC1|✅ proved - complete|shostak|0.020|
|smin_TCC2|✅ proved - complete|shostak|0.030|
|szero_TCC1|✅ proved - complete|shostak|0.010|
|smax_is_max|✅ proved - complete|shostak|0.034|
...
|significand_zero_value_zero|✅ proved - incomplete|shostak|0.314|
|significand_le_value_le_TCC1|✅ proved - complete|shostak|0.030|
|significand_le_value_le|✅ proved - incomplete|shostak|4.226|
|value_monotonicity|✅ proved - incomplete|shostak|1.822|
|exactly_representable_symm_0|✅ proved - incomplete|shostak|0.000|
|er_real_value|✅ proved - incomplete|shostak|0.020|
|zero_is_er|✅ proved - incomplete|shostak|0.222|
...
|er_lower_bound|✅ proved - incomplete|shostak|0.041|
|er_ub_TCC1|✅ proved - incomplete|shostak|0.010|
...
|er_min_pos_prop|✅ proved - incomplete|shostak|0.515|
|er_max_neg_TCC1|✅ proved - incomplete|shostak|0.020|
|er_max_neg_prop|✅ proved - incomplete|shostak|0.355|
|r_real_TCC1|✅ proved - incomplete|shostak|0.020|
|ulp_TCC1|✅ proved - complete|shostak|0.024|
|ulp_TCC2|✅ proved - complete|shostak|0.020|
|ulp_TCC3|✅ proved - incomplete|shostak|0.280|
|ulp_TCC4|✅ proved - incomplete|shostak|0.301|
...
| Formula | Proof Status | Decision Procedure | Time |
| ---     | ---          | ---                | ---  |
|qle_finite_def|✅ proved - incomplete|shostak|0.114|

## `ieee754_qgt`

| Formula | Proof Status | Decision Procedure | Time |
| ---     | ---          | ---                | ---  |
|qgt_finite_def|✅ proved - incomplete|shostak|0.111|

## `ieee754_qge`

| Formula | Proof Status | Decision Procedure | Time |
| ---     | ---          | ---                | ---  |
|qge_finite_def|✅ proved - incomplete|shostak|0.118|

## `ieee754_qeq`

| Formula | Proof Status | Decision Procedure | Time |
| ---     | ---          | ---                | ---  |
|qeq_finite_def|✅ proved - incomplete|shostak|0.121|
...
| Formula | Proof Status | Decision Procedure | Time |
| ---     | ---          | ---                | ---  |
|add_finite_def|✅ proved - incomplete|shostak|0.210|
|add_finites_is_finite|✅ proved - complete|shostak|0.274|
|finite?_projs_finite?_add|✅ proved - incomplete|shostak|0.260|
...
|sub_finite_def|✅ proved - incomplete|shostak|0.488|
|sub_finites_is_finite|✅ proved - incomplete|shostak|0.367|
|finite?_projs_finite?_sub|✅ proved - incomplete|shostak|0.400|

## `ieee754_mul`

| Formula | Proof Status | Decision Procedure | Time |
| ---     | ---          | ---                | ---  |
|mul_finite_def|✅ proved - incomplete|shostak|0.515|
|mul_finites_is_finite|✅ proved - incomplete|shostak|0.551|
|finite?_projs_finite?_mul|✅ proved - incomplete|shostak|0.571|
...
| Formula | Proof Status | Decision Procedure | Time |
| ---     | ---          | ---                | ---  |
|div_correct__finite_TCC1|✅ proved - incomplete|shostak|0.032|
|div_finite_def_TCC1|✅ proved - incomplete|shostak|0.020|
|div_finite_def_TCC2|✅ proved - incomplete|shostak|0.020|
|div_finite_def|✅ proved - incomplete|shostak|0.225|
|div_finites_is_finite|✅ proved - incomplete|shostak|0.694|
|finite?_projs_finite?_div|✅ proved - incomplete|shostak|0.174|

## `ieee754_abs`

| Formula | Proof Status | Decision Procedure | Time |
| ---     | ---          | ---                | ---  |
|abs_correct__finite_TCC1|✅ proved - incomplete|shostak|0.030|
...
|sqt_correct__finite_TCC2|✅ proved - incomplete|shostak|0.030|

## `ieee754_neg`

| Formula | Proof Status | Decision Procedure | Time |
| ---     | ---          | ---                | ---  |
|neg_finite_def|✅ proved - incomplete|shostak|0.023|
|neg_finites_is_finite|✅ proved - complete|shostak|0.050|
...
| Formula | Proof Status | Decision Procedure | Time |
| ---     | ---          | ---                | ---  |
|er_ub_value|✅ proved - incomplete|shostak|1.416|
|er_lb_value|✅ proved - incomplete|shostak|1.416|
|add_single_finite_def|✅ proved - incomplete|shostak|0.022|
|sub_single_finite_def|✅ proved - incomplete|shostak|0.040|
|mul_single_finite_def|✅ proved - incomplete|shostak|0.050|
|div_single_finite_def_TCC1|✅ proved - incomplete|shostak|0.040|
|div_single_finite_def|✅ proved - incomplete|shostak|0.083|
|qeq_single_finite_def|✅ proved - incomplete|shostak|0.030|
|qge_single_finite_def|✅ proved - incomplete|shostak|0.020|
|qgt_single_finite_def|✅ proved - incomplete|shostak|0.015|
...
|finite?_single_add|✅ proved - complete|shostak|0.025|
|finite?_single_sub|✅ proved - incomplete|shostak|0.020|
|finite?_single_mul|✅ proved - incomplete|shostak|0.020|
|finite?_single_div|✅ proved - incomplete|shostak|0.030|
|finite?_single_neg|✅ proved - complete|shostak|0.016|
...
|single__finite?_projs_finite?_div|✅ proved - incomplete|shostak|0.075|
...
| Formula | Proof Status | Decision Procedure | Time |
| ---     | ---          | ---                | ---  |
|aerr_ulp_div_TCC1|✅ proved - complete|shostak|0.330|
|aerr_ulp_div_TCC2|✅ proved - complete|shostak|0.057|
|aerr_ulp_div_TCC3|✅ proved - incomplete|shostak|0.942|
|aerr_ulp_div_correct_TCC1|✅ proved - incomplete|shostak|0.093|
|aerr_ulp_div_correct_TCC2|✅ proved - incomplete|shostak|0.070|
...
| Formula | Proof Status | Decision Procedure | Time |
| ---     | ---          | ---                | ---  |
|aerr_div_def_TCC1|✅ proved - complete|shostak|0.026|
