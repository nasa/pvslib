...
\def\opplustwofn#1#2{{#1+#2}}% How to print function + with arity (2)
\begin{alltt}
\pvsid{complex\_lnexp}: \pvskey{THEORY}
 \pvskey{BEGIN}

  \pvskey{IMPORTING} \pvsid{polar}, \pvsid{trig}@\pvsid{trig\_ineq}, \pvsid{trig\_aux}, \pvsid{lnexp}@\pvsid{ln\_exp}
  ...
  \pvsid{exp}\pvsid{(}\(z\)\pvsid{)}: \({\pvssubscript{\mathbb{C}}{{\not=}0}}\) \pvskey{=}
      \pvsid{complex\_}\pvsid{(}\(\optimestwofn{\pvsid{exp}\pvsid{(}\Reonefn{z}\pvsid{)}}{\pvsid{cos}\pvsid{(}\Imonefn{z}\pvsid{)}}\),
                \(\optimestwofn{\pvsid{exp}\pvsid{(}\Reonefn{z}\pvsid{)}}{\pvsid{sin}\pvsid{(}\Imonefn{z}\pvsid{)}}\)\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{Re\_exp}: \pvskey{LEMMA} \(\Reonefn{\pvsid{exp}\pvsid{(}z\pvsid{)}}\) \(=\) \(\optimestwofn{\pvsid{exp}\pvsid{(}\Reonefn{z}\pvsid{)}}{\pvsid{cos}\pvsid{(}\Imonefn{z}\pvsid{)}}\)\vspace*{\pvsdeclspacing}

  \pvsid{Im\_exp}: \pvskey{LEMMA} \(\Imonefn{\pvsid{exp}\pvsid{(}z\pvsid{)}}\) \(=\) \(\optimestwofn{\pvsid{exp}\pvsid{(}\Reonefn{z}\pvsid{)}}{\pvsid{sin}\pvsid{(}\Imonefn{z}\pvsid{)}}\)\vspace*{\pvsdeclspacing}

  \pvskey{AUTO\_REWRITE+} \pvsid{Re\_exp}


  \pvskey{AUTO\_REWRITE+} \pvsid{Im\_exp}


  \pvsid{exp\_i\_pi}: \pvskey{LEMMA} \pvsid{c\_eq}\pvsid{(}\pvsid{exp}\pvsid{(}\(\optimestwofn{{\imath}}{\pi}\)\pvsid{)}, \(\opdifferenceonefn{1}\)\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{exp\_plus}: \pvskey{LEMMA}
    \pvsid{c\_eq}\pvsid{(}\pvsid{exp}\pvsid{(}\(\opplustwofn{x}{y}\)\pvsid{)}, \(\optimestwofn{\pvsid{exp}\pvsid{(}x\pvsid{)}}{\pvsid{exp}\pvsid{(}y\pvsid{)}}\)\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{exp\_negate}: \pvskey{LEMMA} \pvsid{c\_eq}\pvsid{(}\pvsid{exp}\pvsid{(}\(\opdifferenceonefn{x}\)\pvsid{)}, \(\opdividetwofn{1}{\pvsid{exp}\pvsid{(}x\pvsid{)}}\)\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{exp\_minus}: \pvskey{LEMMA}
    \pvsid{c\_eq}\pvsid{(}\pvsid{exp}\pvsid{(}\(\opdifferencetwofn{x}{y}\)\pvsid{)}, \(\opdividetwofn{\pvsid{exp}\pvsid{(}x\pvsid{)}}{\pvsid{exp}\pvsid{(}y\pvsid{)}}\)\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{exp\_periodicity}: \pvskey{LEMMA}
    \pvsid{c\_eq}\pvsid{(}\pvsid{exp}\pvsid{(}\(\opplustwofn{x}{\optimestwofn{\pvsid{(}\optimestwofn{\optimestwofn{2}{j}}{\pi}\pvsid{)}}{{\imath}}}\)\pvsid{)}, \pvsid{exp}\pvsid{(}\(x\)\pvsid{)}\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{abs\_exp}: \pvskey{LEMMA} \(\absonefn{\pvsid{exp}\pvsid{(}z\pvsid{)}}\) \(=\) \pvsid{exp}\pvsid{(}\(\Reonefn{z}\)\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{arg\_exp}: \pvskey{LEMMA}
    \(\opdifferenceonefn{\pi}\) \(<\) \(\Imonefn{z}\) \(\wedge\) \(\Imonefn{z}\) \(\leq\) \(\pi\) \(\Rightarrow\)
     \pvsid{arg}\pvsid{(}\pvsid{exp}\pvsid{(}\(z\)\pvsid{)}\pvsid{)} \(=\) \(\Imonefn{z}\)\vspace*{\pvsdeclspacing}

  \pvsid{ln}\pvsid{(}\pvsid{n0z}\pvsid{)}: \(\mathbb{C}\) \pvskey{=} \pvsid{complex\_}\pvsid{(}\pvsid{ln}\pvsid{(}\(\absonefn{\pvsid{n0z}}\)\pvsid{)}, \pvsid{arg}\pvsid{(}\pvsid{n0z}\pvsid{)}\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{Re\_ln}: \pvskey{LEMMA} \(\Reonefn{\pvsid{ln}\pvsid{(}\pvsid{n0z}\pvsid{)}}\) \(=\) \pvsid{ln}\pvsid{(}\(\absonefn{\pvsid{n0z}}\)\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{Im\_ln}: \pvskey{LEMMA} \(\Imonefn{\pvsid{ln}\pvsid{(}\pvsid{n0z}\pvsid{)}}\) \(=\) \pvsid{arg}\pvsid{(}\pvsid{n0z}\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvskey{AUTO\_REWRITE+} \pvsid{Re\_ln}


  \pvskey{AUTO\_REWRITE+} \pvsid{Im\_ln}


  \pvskey{AUTO\_REWRITE+} \pvsid{abs\_exp}


  \pvskey{AUTO\_REWRITE+} \pvsid{arg\_exp}


  \pvsid{ln\_exp}: \pvskey{LEMMA}
    \(\optimestwofn{\pvsid{(}\opdifferencetwofn{\optimestwofn{2}{j}}{1}\pvsid{)}}{\pi}\) \(<\) \(\Imonefn{z}\) \(\wedge\)
     \(\Imonefn{z}\) \(\leq\) \(\optimestwofn{\pvsid{(}\opplustwofn{\optimestwofn{2}{j}}{1}\pvsid{)}}{\pi}\)
     \(\Rightarrow\) \pvsid{c\_eq}\pvsid{(}\pvsid{ln}\pvsid{(}\pvsid{exp}\pvsid{(}\(z\)\pvsid{)}\pvsid{)}, \(\opdifferencetwofn{z}{\optimestwofn{\pvsid{(}\optimestwofn{\optimestwofn{2}{j}}{\pi}\pvsid{)}}{{\imath}}}\)\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{exp\_ln}: \pvskey{LEMMA} \pvsid{c\_eq}\pvsid{(}\pvsid{exp}\pvsid{(}\pvsid{ln}\pvsid{(}\pvsid{n0z}\pvsid{)}\pvsid{)}, \pvsid{n0z}\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{ln\_mult}: \pvskey{LEMMA}
    \pvsid{c\_eq}\pvsid{(}\pvsid{ln}\pvsid{(}\(\optimestwofn{\pvsid{n0x}}{\pvsid{n0y}}\)\pvsid{)},
          \(\opdifferencetwofn{{\zbox{\({\opplustwofn{{\zbox{\({\pvsid{ln}\pvsid{(}\pvsid{n0x}\pvsid{)}}\)}}}{{\zbox{\({\pvsid{ln}\pvsid{(}\pvsid{n0y}\pvsid{)}}\)}}}}\)}}}{{\zbox{\({\optimestwofn{{\zbox{\({\pvskey{IF} \opplustwofn{{\zbox{\({\pvsid{arg}\pvsid{(}\pvsid{n0x}\pvsid{)}}\)}}}{{\zbox{\({\pvsid{arg}\pvsid{(}\pvsid{n0y}\pvsid{)}}\)}}} > \pi}\)} \zbox{\({\pvskey{THEN} \optimestwofn{{\zbox{\({2}\)}}}{{\zbox{\({\pi}\)}}}}\)} \zbox{\({\pvskey{ELSIF} \opplustwofn{{\zbox{\({\pvsid{arg}\pvsid{(}\pvsid{n0x}\pvsid{)}}\)}}}{{\zbox{\({\pvsid{arg}\pvsid{(}\pvsid{n0y}\pvsid{)}}\)}}} \leq \opdifferenceonefn{{\zbox{\({\pi}\)}}}}\)} \zbox{\({\pvskey{THEN} \optimestwofn{{\zbox{\({\opdifferenceonefn{{\zbox{\({2}\)}}}}\)}}}{{\zbox{\({\pi}\)}}}}\)} \zbox{\({\pvskey{ELSE} 0}\)} \hbox{\({\pvskey{ENDIF}}\)}}}{{\hbox{\({{\imath}}\)}}}}\)}}}\)\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{ln\_inv}: \pvskey{LEMMA}
    \pvsid{c\_eq}\pvsid{(}\pvsid{ln}\pvsid{(}\(\opdividetwofn{1}{\pvsid{n0x}}\)\pvsid{)},
          \(\opdifferencetwofn{{\zbox{\({\optimestwofn{{\zbox{\({\pvskey{IF} \pvsid{arg}\pvsid{(}\pvsid{n0x}\pvsid{)} = \pi}\)} \zbox{\({\pvskey{THEN} \optimestwofn{{\zbox{\({2}\)}}}{{\zbox{\({\pi}\)}}}}\)} \zbox{\({\pvskey{ELSE} 0}\)} \hbox{\({\pvskey{ENDIF}}\)}}}{{\hbox{\({{\imath}}\)}}}}\)}}}{{\hbox{\({\pvsid{ln}\pvsid{(}\pvsid{n0x}\pvsid{)}}\)}}}\)\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{ln\_div}: \pvskey{LEMMA}
    \pvsid{c\_eq}\pvsid{(}\pvsid{ln}\pvsid{(}\(\opdividetwofn{\pvsid{n0x}}{\pvsid{n0y}}\)\pvsid{)},
          \(\opdifferencetwofn{{\zbox{\({\opdifferencetwofn{{\zbox{\({\pvsid{ln}\pvsid{(}\pvsid{n0x}\pvsid{)}}\)}}}{{\zbox{\({\pvsid{ln}\pvsid{(}\pvsid{n0y}\pvsid{)}}\)}}}}\)}}}{{\zbox{\({\optimestwofn{{\zbox{\({\pvskey{IF} \opdifferencetwofn{{\zbox{\({\pvsid{arg}\pvsid{(}\pvsid{n0x}\pvsid{)}}\)}}}{{\zbox{\({\pvsid{arg}\pvsid{(}\pvsid{n0y}\pvsid{)}}\)}}} > \pi}\)} \zbox{\({\pvskey{THEN} \optimestwofn{{\zbox{\({2}\)}}}{{\zbox{\({\pi}\)}}}}\)} \zbox{\({\pvskey{ELSIF} \opdifferencetwofn{{\zbox{\({\pvsid{arg}\pvsid{(}\pvsid{n0x}\pvsid{)}}\)}}}{{\zbox{\({\pvsid{arg}\pvsid{(}\pvsid{n0y}\pvsid{)}}\)}}} \leq \opdifferenceonefn{{\zbox{\({\pi}\)}}}}\)} \zbox{\({\pvskey{THEN} \optimestwofn{{\zbox{\({\opdifferenceonefn{{\zbox{\({2}\)}}}}\)}}}{{\zbox{\({\pi}\)}}}}\)} \zbox{\({\pvskey{ELSE} 0}\)} \hbox{\({\pvskey{ENDIF}}\)}}}{{\hbox{\({{\imath}}\)}}}}\)}}}\)\pvsid{)}\vspace*{\pvsdeclspacing}

 \pvskey{END} \pvsid{complex\_lnexp}\end{alltt}
